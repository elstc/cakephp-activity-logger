...
class LoggerBehaviorTest extends TestCase
{
    ...
    public function testLogScope()
    {
        $this->assertSame([
            'Elastic/ActivityLogger.Authors' => null,
            '\MyApp' => true,
        ], $this->Authors->logScope(), 'can get log scope');
        //
        $this->assertSame([
            'Elastic/ActivityLogger.Articles' => null,
            'Elastic/ActivityLogger.Authors' => null,
            '\MyApp' => true,
        ], $this->Articles->logScope(), 'can get log scope');
        ...
        $this->assertSame([
            ...
            '\MyApp' => true,
        ], $this->Authors->logScope(), 'updated log scope');
        //
        ...
        $this->assertSame([
            ...
            'Foo' => '005',
            'Hoge' => true,
        ], $this->Articles->logScope(), 'updated log scope');
        // Reset scope
        ...
        $this->assertSame([
            ...
            'Elastic/ActivityLogger.Authors' => null,
            '\MyApp' => true,
        ], $this->Articles->logScope(), 'will reset log scope');
    }
